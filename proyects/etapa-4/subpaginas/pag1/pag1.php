...
<body>
    ...
    <div class="registro">
        <form class="formulario" action="pag1.php" method="POST">
            <h2 class="registro__h2">Formulario de Registro</h2>
            <br>
            <input class="textbox" type="text" name="Nombre" id="" placeholder="Escriba su nombre">
            <br>
            <input class="textbox" type="email" name="Correo" id="" placeholder="Escriba su correo electronico">
            <br>
            <input class="textbox" type="password" name="Contraseña" id="" placeholder="Ingrese una contraseña">
            <br>
        ...
        <div class="resultado">
            <p>
                ...
                if($_POST){
                    echo "Su cuenta ha sido creada correctamente.";
                }
