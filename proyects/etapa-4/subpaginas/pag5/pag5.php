...
<body>
    ...
    <div class="cajita">
        ...
        <br>
        <?php
            $libro = array("Blancanieves","Robin Hodd");
            foreach($libro as $disponible)
            {
                echo "Tenemos disponible el libro de ", $disponible, "<br>";
            }
            $autor = array("Blancanieves" => "Grimm", "Robin hodd" => "Dominic Minghella");
            foreach($autor as $x => $y)
            {
                echo "El libro ", $x, "fue escrito por ", $y, "<br>";
            }
        ?>
    </div>
